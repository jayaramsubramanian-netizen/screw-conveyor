...
export default function ReactorPage() {
    ...
    const run = async () => {
        ...
        setError(null);
        try {
            const { data } = await axios.post('/api/v1/process/reactor', {
                diam, len, feed, rho,
