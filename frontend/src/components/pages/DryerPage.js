...
export default function DryerPage() {
    ...
    const run = async () => {
        ...
        setError(null);
        try {
            const { data } = await axios.post('/api/v1/process/dryer', {
                diam, len, feed, rho,
