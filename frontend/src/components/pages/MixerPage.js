...
export default function MixerPage() {
    ...
    const run = async () => {
        ...
        setError(null);
        try {
            const { data } = await axios.post('/api/v1/process/mixer', {
                diam, len, feed, rho,
