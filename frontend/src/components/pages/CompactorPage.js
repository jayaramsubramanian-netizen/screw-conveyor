...
export default function CompactorPage() {
    ...
    const run = async () => {
        ...
        setError(null);
        try {
            const { data } = await axios.post('/api/v1/process/compactor', {
                diam, len, feed, rho,
