...
export default function CoolerPage() {
    ...
    const run = async () => {
        ...
        setError(null);
        try {
            const { data } = await axios.post('/api/v1/process/cooler', {
                diam, len, feed, rho,
